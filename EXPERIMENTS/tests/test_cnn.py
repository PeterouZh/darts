...
class TestingTrainSearch(unittest.TestCase):
  ...
  def test_cnn_cifar10_architecture_evaluation(self):
    """
    Usage:
        source activate Peterou_torch_0_3_1_tv_0_2_0
        ...
        export PYTHONPATH=../../submodule:../../cnn:../..:..
        python -c "import test_cnn; \
        test_cnn.TestingTrainSearch().test_cnn_cifar10_architecture_evaluation()"
    ...
    def build_args():
      argv_str = f"""
            --config configs/cnn_cifar10.yaml
            --command cnn_cifar10_architecture_evaluation
            --resume False --resume_path None
            --resume_root None
            """
      parser = utils.args_parser.build_parser()
...
class TestingPlot(unittest.TestCase):
  ...
  def test_cnn_cifar10_train_search_plot(self):
    """
    Usage:
        source activate Peterou_torch_0_3_1_tv_0_2_0
        ...
        export PYTHONPATH=../submodule:../cnn:..
        python -c "import test_cnn; \
        test_cnn.TestingTrainSearch().test_cnn_cifar10_train_search_plot()"
    ...
    def build_args():
      argv_str = f"""
            --config configs/cnn_cifar10.yaml
            --command cnn_cifar10_train_search_plot
            --resume False --resume_path None
            --resume_root None
            """
      parser = utils.args_parser.build_parser()
    ...
    plot_utils.parse_logfile(args, myargs)
    input('End %s' % outdir)
    return
